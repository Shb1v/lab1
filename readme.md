...
Находясь в /home/sh1v, ввожу в терминал: <br />
```$ mkdir lab1``` <br />
...
Инициализирован пустой репозиторий Git в /home/sh1v/lab1/.git/<br />
Создам файл readme.md:<br />
```$ touch readme.md```<br />
Перехожу в директорию /home/shiv:<br />
```$ cd /home/sh1v```<br />
...
06. ```$ find `pwd` -name any.hpp```<br />
    Вывод: <br />
/home/sh1v/boost_1_69_0/boost/fusion/algorithm/query/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/fusion/algorithm/query/detail/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/fusion/include/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/spirit/home/support/algorithm/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/type_erasure/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/hana/fwd/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/hana/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/proto/detail/any.hpp<br />
/home/sh1v/boost_1_69_0/boost/xpressive/detail/utility/any.hpp<br />
...
09. ```
    ...
    $ mv *.a /home/sh1v/boost-libs
    ```
    
10. ```
    $ cd /home/sh1v/boost-libs
